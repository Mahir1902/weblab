    ...
    <footer className="border-t border-[#1F2937] bg-[#0A0A0A]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-16">
          ...
          {/* Col 2: Navigation */}
          <div>
            <h3 className="text-[#F9FAFB] text-sm font-semibold uppercase tracking-wider mb-4">
              Navigation
            </h3>
        ...
        <div className="mt-12 pt-6 border-t border-[#111827] flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-[#6B7280]">

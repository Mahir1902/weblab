    ...
    <footer className="border-t border-[var(--color-border)] bg-[var(--color-bg)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-16">
          ...
          {/* Col 2: Navigation */}
          <div>
            <h3 className="text-[var(--color-text-primary)] text-sm font-semibold uppercase tracking-wider mb-4">
              Navigation
            </h3>
            <ul className="flex flex-col gap-2.5">
              ...
              <li>
                <Link
                  href="#book-a-call"
                  className="text-[var(--color-accent)] text-sm font-medium hover:text-[var(--color-accent-hover)] transition-colors"
                >
                  Book a Free Call
                </Link>
              </li>
        ...
        <div className="mt-12 pt-6 border-t border-[var(--color-border-subtle)] flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-[var(--color-text-dim)]">
